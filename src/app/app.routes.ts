...
import { UnderwriterRecordComponent } from './routes/records/underwriter-record/underwriter-record.component';
import { UnderwriterListComponent } from './routes/lists/underwriter-list/underwriter-list.component';
import { NamedInsuredsListComponent } from './routes/lists/named-insureds-list/named-insureds-list.component';
import { NamedInsuredRecordComponent } from './routes/records/named-insured-record/named-insured-record.component';
